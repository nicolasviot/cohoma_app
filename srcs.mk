...
srcs_sma ?= src/Dispatcher.sma src/Reticule.sma src/Strip.sma src/Slider.sma src/CheckBox.sma src/Animator.sma src/TextLineEdit.sma \
            src/Button.sma src/PanAndZoom.sma src/StatusSelector.sma src/GraphNode.sma  src/Node.sma src/Edge.sma \
            src/TaskEdge.sma src/TaskTrap.sma src/SafetyPilot.sma src/TaskAreaSummit.sma src/TaskArea.sma src/TaskLayer.sma\
            src/Trap.sma src/TrapLayer.sma src/ManagerId.sma \
