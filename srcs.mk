...
srcs_sma := src/Slider.sma src/Animator.sma src/TextLineEdit.sma src/PanAndZoom.sma src/Waypoints.sma src/PixmapTile.sma src/MapLayer.sma src/Map.sma src/WidgetMap.sma src/main.sma
# or
