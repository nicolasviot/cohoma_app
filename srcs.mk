...
srcs_sma ?= src/ClockComponent.sma src/Reticule.sma src/Strip.sma src/Slider.sma src/CheckBox.sma src/Animator.sma src/TextLineEdit.sma \
            ...
            src/Edge.sma src/TaskEdge.sma src/TaskTrap.sma src/TrapLayer.sma src/Node.sma src/ManagerId.sma \
            src/SafetyPilot.sma src/TaskAreaSummit.sma src/Lima.sma src/LimaLayer.sma \
            src/Lima.sma src/LimaLayer.sma src/ExclusionArea.sma src/ExclusionAreaLayer.sma src/SiteLayer.sma src/TaskLayer.sma \
