...
NavGraph (Process _map, Process _context, Process f, Process _model_manager)
{
	...
	if (model_manager.IS_DEBUG)
	{
		addChildrenTo nodes {
			...
			//Baynes data
			Node node1 (map, f, 48.866366, 1.885056, 0.0, 0, "", 1, _context)
			Node node2 (map, f, 48.866246, 1.885335, 0.0, 0, "", 2, _context)
			Node node3 (map, f, 48.866733, 1.886022, 0.0, 0, "", 3, _context)
			Node node4 (map, f, 48.865385, 1.886623, 0.0, 0, "", 4, _context)
			Node node5 (map, f, 48.864482, 1.884327, 0.0, 0, "", 5, _context)
			Node node6 (map, f, 48.865308, 1.885357, 0.0, 0, "", 6, _context)
			Node node7 (map, f, 48.865294, 1.885099, 0.0, 0, "", 7, _context)
			Node node8 (map, f, 48.865421, 1.885035, 0.0, 0, "", 8, _context)
			Node node9 (map, f, 48.863127, 1.887159, 0.0, 0, "", 9, _context)
			Node node10 (map, f, 48.864644, 1.886601, 0.0, 0, "", 10, _context)
			Node node11 (map, f, 48.862964, 1.888790, 0.0, 0, "", 11, _context)
			Node node12 (map, f, 48.862774, 1.889369, 0.0, 0, "", 12, _context)
			Node node13 (map, f, 48.862633, 1.888962, 0.0, 0, "", 13, _context)
			Node node14 (map, f, 48.862626, 1.888361, 0.0, 0, "", 14, _context)
			Node node15 (map, f, 48.862527, 1.888146, 0.0, 0, "", 15, _context)
			Node node16 (map, f, 48.862823, 1.888425, 0.0, 0, "", 16, _context)
			Node node17 (map, f, 48.862964, 1.888382, 0.0, 0, "", 17, _context)
			Node node18 (map, f, 48.862668, 1.888103, 0.0, 0, "", 18, _context)
			Node node19 (map, f, 48.860833, 1.886945, 0.0, 0, "", 19, _context)
			Node node20 (map, f, 48.859703, 1.887095, 0.0, 0, "", 20, _context)
			Node node21 (map, f, 48.860268, 1.886988, 0.0, 0, "", 21, _context)
			Node node22 (map, f, 48.860303, 1.887224, 0.0, 0, "", 22, _context)
			Node node23 (map, f, 48.861023, 1.892030, 0.0, 0, "", 23, _context)
			Node node24 (map, f, 48.860684, 1.887024, 0.0, 1, "PPO10", 24, _context)
			Node node25 (map, f, 48.863247, 1.889708, 0.0, 1, "PPO20", 25, _context)
			Node node26 (map, f, 48.864712, 1.886771, 0.0, 1, "PPO30", 26, _context)
			Node node27 (map, f, 48.866231, 1.883874, 0.0, 1, "PPO40", 27, _context)
			Node node28 (map, f, 48.861095, 1.893314, 0.0, 1, "depart", 28, _context)
			Node node29 (map, f, 48.861026, 1.892661, 0.0, 0, "T101", 29, _context)
			Node node30 (map, f, 48.860770, 1.890403, 0.0, 0, "T102", 30, _context)
			Node node31 (map, f, 48.860347, 1.887549, 0.0, 0, "T103", 31, _context)
			Node node32 (map, f, 48.861903, 1.884679, 0.0, 0, "T201", 32, _context)
			Node node33 (map, f, 48.862245, 1.885626, 0.0, 0, "T202", 33, _context)
			Node node34 (map, f, 48.861444, 1.886598, 0.0, 0, "T203", 34, _context)
			Node node35 (map, f, 48.860894, 1.887346, 0.0, 0, "T204", 35, _context)
			Node node36 (map, f, 48.862156, 1.886664, 0.0, 0, "T205", 36, _context)
			Node node37 (map, f, 48.861729, 1.887151, 0.0, 0, "T206", 37, _context)
			Node node38 (map, f, 48.862424, 1.887408, 0.0, 0, "T207", 38, _context)
			Node node39 (map, f, 48.861977, 1.887691, 0.0, 0, "T208", 39, _context)
			Node node40 (map, f, 48.862518, 1.887883, 0.0, 0, "T209", 40, _context)
			Node node41 (map, f, 48.862289, 1.888325, 0.0, 0, "T210", 41, _context)
			Node node42 (map, f, 48.862163, 1.889254, 0.0, 0, "T211", 42, _context)
			Node node43 (map, f, 48.862725, 1.888833, 0.0, 0, "T212", 43, _context)
			Node node44 (map, f, 48.863043, 1.889099, 0.0, 0, "T213", 44, _context)
			Node node45 (map, f, 48.862678, 1.889461, 0.0, 0, "T214", 45, _context)
			Node node46 (map, f, 48.862383, 1.889740, 0.0, 0, "T215", 46, _context)
			Node node47 (map, f, 48.862763, 1.889964, 0.0, 0, "T216", 47, _context)
			Node node48 (map, f, 48.863058, 1.885090, 0.0, 0, "T301", 48, _context)
			Node node49 (map, f, 48.863046, 1.885690, 0.0, 0, "T302", 49, _context)
			Node node50 (map, f, 48.863652, 1.885990, 0.0, 0, "T303", 50, _context)
			Node node51 (map, f, 48.864453, 1.886981, 0.0, 0, "T304", 51, _context)
			Node node52 (map, f, 48.864295, 1.887435, 0.0, 0, "T305", 52, _context)
			Node node53 (map, f, 48.863883, 1.887607, 0.0, 0, "T306", 53, _context)
			Node node54 (map, f, 48.863599, 1.888023, 0.0, 0, "T307", 54, _context)
			Node node55 (map, f, 48.862863, 1.888135, 0.0, 0, "T308", 55, _context)
			Node node56 (map, f, 48.863924, 1.888111, 0.0, 0, "T309", 56, _context)
			Node node57 (map, f, 48.864835, 1.887409, 0.0, 0, "T310", 57, _context)
			Node node58 (map, f, 48.864414, 1.888591, 0.0, 0, "T311", 58, _context)
			Node node59 (map, f, 48.863518, 1.888965, 0.0, 0, "T312", 59, _context)
			Node node60 (map, f, 48.863836, 1.889217, 0.0, 0, "T313", 60, _context)
			Node node61 (map, f, 48.863975, 1.889637, 0.0, 0, "T314", 61, _context)
			Node node62 (map, f, 48.865145, 1.884143, 0.0, 0, "T401", 62, _context)
			Node node63 (map, f, 48.864363, 1.885115, 0.0, 0, "T402", 63, _context)
			Node node64 (map, f, 48.865267, 1.884632, 0.0, 0, "T403", 64, _context)
			Node node65 (map, f, 48.865840, 1.884346, 0.0, 0, "T404", 65, _context)
			Node node66 (map, f, 48.866336, 1.884540, 0.0, 0, "T405", 66, _context)
			Node node67 (map, f, 48.865674, 1.884868, 0.0, 0, "T406", 67, _context)
			Node node68 (map, f, 48.865029, 1.885209, 0.0, 0, "T407", 68, _context)
			Node node69 (map, f, 48.865087, 1.885590, 0.0, 0, "T408", 69, _context)
			Node node70 (map, f, 48.865330, 1.885557, 0.0, 0, "T409", 70, _context)
			Node node71 (map, f, 48.865020, 1.886082, 0.0, 0, "T410", 71, _context)
			Node node72 (map, f, 48.865494, 1.886767, 0.0, 0, "T411", 72, _context)
			Node node73 (map, f, 48.865489, 1.886222, 0.0, 0, "T412", 73, _context)
			Node node74 (map, f, 48.866127, 1.885171, 0.0, 0, "T413", 74, _context)
			Node node75 (map, f, 48.866529, 1.884958, 0.0, 0, "T414", 75, _context)
			Node node76 (map, f, 48.866835, 1.885851, 0.0, 0, "T415", 76, _context)
			Node node77 (map, f, 48.862350, 1.885979, 0.0, 0, "", 77, _context)
			Node node78 (map, f, 48.862139, 1.885250, 0.0, 0, "", 78, _context)
			Node node79 (map, f, 48.861045, 1.887181, 0.0, 0, "", 79, _context)
			Node node80 (map, f, 48.861440, 1.887267, 0.0, 0, "", 80, _context)
			Node node81 (map, f, 48.861616, 1.887374, 0.0, 0, "", 81, _context)
			Node node82 (map, f, 48.861334, 1.887074, 0.0, 0, "", 82, _context)
			Node node83 (map, f, 48.862484, 1.887653, 0.0, 0, "", 83, _context)
			Node node84 (map, f, 48.862393, 1.888039, 0.0, 0, "", 84, _context)
			Node node85 (map, f, 48.862407, 1.887181, 0.0, 0, "", 85, _context)
			Node node86 (map, f, 48.862068, 1.887310, 0.0, 0, "", 86, _context)
			Node node87 (map, f, 48.862689, 1.887417, 0.0, 0, "", 87, _context)
			Node node88 (map, f, 48.862746, 1.887889, 0.0, 0, "", 88, _context)
			Node node89 (map, f, 48.863183, 1.888232, 0.0, 0, "", 89, _context)
			Node node90 (map, f, 48.863395, 1.889133, 0.0, 0, "", 90, _context)
			Node node91 (map, f, 48.863564, 1.889584, 0.0, 0, "", 91, _context)
			Node node92 (map, f, 48.863642, 1.890078, 0.0, 0, "", 92, _context)
			Node node93 (map, f, 48.863811, 1.889412, 0.0, 0, "", 93, _context)
			Node node94 (map, f, 48.864143, 1.889112, 0.0, 0, "", 94, _context)
			Node node95 (map, f, 48.863931, 1.888533, 0.0, 0, "", 95, _context)
			Node node96 (map, f, 48.864065, 1.887782, 0.0, 0, "", 96, _context)
			Node node97 (map, f, 48.864284, 1.886773, 0.0, 0, "", 97, _context)
			Node node98 (map, f, 48.864955, 1.887631, 0.0, 0, "", 98, _context)
			Node node99 (map, f, 48.864228, 1.885185, 0.0, 0, "", 99, _context)
			Node node100 (map, f, 48.864334, 1.885550, 0.0, 0, "", 100, _context)
			Node node101 (map, f, 48.864108, 1.884799, 0.0, 0, "", 101, _context)
			Node node102 (map, f, 48.865025, 1.887932, 0.0, 0, "", 102, _context)
			Node node103 (map, f, 48.864305, 1.888425, 0.0, 0, "", 103, _context)
			Node node104 (map, f, 48.865943, 1.884563, 0.0, 0, "", 104, _context)
			Node node105 (map, f, 48.865329, 1.884091, 0.0, 0, "", 105, _context)
			Node node106 (map, f, 48.866211, 1.884520, 0.0, 0, "", 106, _context)
			Node node107 (map, f, 48.866119, 1.884906, 0.0, 0, "", 107, _context)
