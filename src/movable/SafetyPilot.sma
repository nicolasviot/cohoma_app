...
SafetyPilot (Process map, Process _context, Process _model, Process _svg)
{
    ...
    DraggableItemWithRadius draggable_item (map, _context, model.lat, model.lon, model.radius, screen_translation.tx, screen_translation.ty, picking, _context.frame_released, bg.c.r)
