...
EnvMapLayer (Process map){
	...
	visibility_map_resolution * 1.52 / get_resolution ($map.zoomLevel) =:> scale.sx
	visibility_map_resolution * 1.52 / get_resolution ($map.zoomLevel) =:> scale.sy

	- (visibility_map.width * visibility_map_resolution * 1.52/ get_resolution ($map.zoomLevel)) / 2 =:> t_to_center.tx
	- (visibility_map.height * visibility_map_resolution * 1.52/ get_resolution ($map.zoomLevel)) / 2 =:> t_to_center.ty
}