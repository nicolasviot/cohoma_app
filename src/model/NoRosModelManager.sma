...
NoRosModelManager (Process _context, int _is_debug) inherits ModelManager (_context, _is_debug)
{
    ...
    addChildrenTo this.nodes {
        ...
        NodeModel node_0 (_context, 0, 4, "", 48.8664, 1.88506, 0, 0)
        NodeModel node_1 (_context, 1, 4, "", 48.8662, 1.88534, 0, 0)
        NodeModel node_2 (_context, 2, 4, "", 48.8667, 1.88602, 0, 0)
        NodeModel node_3 (_context, 3, 4, "", 48.8654, 1.88662, 0, 0)
        NodeModel node_4 (_context, 4, 4, "", 48.8645, 1.88433, 0, 0)
        NodeModel node_5 (_context, 5, 4, "", 48.8653, 1.88536, 0, 0)
        NodeModel node_6 (_context, 6, 4, "", 48.8653, 1.8851, 0, 0)
        NodeModel node_7 (_context, 7, 4, "", 48.8654, 1.88504, 0, 0)
        NodeModel node_8 (_context, 8, 3, "", 48.8631, 1.88716, 0, 0)
        NodeModel node_9 (_context, 9, 3, "", 48.8646, 1.8866, 0, 0)
        NodeModel node_10 (_context, 10, 2, "", 48.863, 1.88879, 0, 0)
        NodeModel node_11 (_context, 11, 2, "", 48.8628, 1.88937, 0, 0)
        NodeModel node_12 (_context, 12, 2, "", 48.8626, 1.88896, 0, 0)
        NodeModel node_13 (_context, 13, 2, "", 48.8626, 1.88836, 0, 0)
        NodeModel node_14 (_context, 14, 2, "", 48.8625, 1.88815, 0, 0)
        NodeModel node_15 (_context, 15, 2, "", 48.8628, 1.88843, 0, 0)
        NodeModel node_16 (_context, 16, 3, "", 48.863, 1.88838, 0, 0)
        NodeModel node_17 (_context, 17, 2, "", 48.8627, 1.8881, 0, 0)
        NodeModel node_18 (_context, 18, 2, "", 48.8608, 1.88694, 0, 0)
        NodeModel node_19 (_context, 19, 1, "", 48.8597, 1.88709, 0, 0)
        NodeModel node_20 (_context, 20, 1, "", 48.8603, 1.88699, 0, 0)
        NodeModel node_21 (_context, 21, 1, "", 48.8603, 1.88722, 0, 0)
        NodeModel node_22 (_context, 22, 1, "", 48.861, 1.89203, 0, 0)
        NodeModel node_23 (_context, 23, 1, "PPO10", 48.8607, 1.88702, 0, 1)
        NodeModel node_24 (_context, 24, 2, "PPO20", 48.8632, 1.88971, 0, 1)
        NodeModel node_25 (_context, 25, 3, "PPO30", 48.8647, 1.88677, 0, 1)
        NodeModel node_26 (_context, 26, 4, "PPO40", 48.8662, 1.88387, 0, 1)
        NodeModel node_27 (_context, 27, 0, "depart", 48.8611, 1.89331, 0, 1)
        NodeModel node_28 (_context, 28, 1, "T101", 48.861, 1.89266, 0, 0)
        NodeModel node_29 (_context, 29, 1, "T102", 48.8608, 1.8904, 0, 0)
        NodeModel node_30 (_context, 30, 1, "T103", 48.8603, 1.88755, 0, 0)
        NodeModel node_31 (_context, 31, 2, "T201", 48.8619, 1.88468, 0, 0)
        NodeModel node_32 (_context, 32, 2, "T202", 48.8622, 1.88563, 0, 0)
        NodeModel node_33 (_context, 33, 2, "T203", 48.8614, 1.8866, 0, 0)
        NodeModel node_34 (_context, 34, 2, "T204", 48.8609, 1.88735, 0, 0)
        NodeModel node_35 (_context, 35, 2, "T205", 48.8622, 1.88666, 0, 0)
        NodeModel node_36 (_context, 36, 2, "T206", 48.8617, 1.88715, 0, 0)
        NodeModel node_37 (_context, 37, 2, "T207", 48.8624, 1.88741, 0, 0)
        NodeModel node_38 (_context, 38, 2, "T208", 48.862, 1.88769, 0, 0)
        NodeModel node_39 (_context, 39, 2, "T209", 48.8625, 1.88788, 0, 0)
        NodeModel node_40 (_context, 40, 2, "T210", 48.8623, 1.88832, 0, 0)
        NodeModel node_41 (_context, 41, 2, "T211", 48.8622, 1.88925, 0, 0)
        NodeModel node_42 (_context, 42, 2, "T212", 48.8627, 1.88883, 0, 0)
        NodeModel node_43 (_context, 43, 2, "T213", 48.863, 1.8891, 0, 0)
        NodeModel node_44 (_context, 44, 2, "T214", 48.8627, 1.88946, 0, 0)
        NodeModel node_45 (_context, 45, 2, "T215", 48.8624, 1.88974, 0, 0)
        NodeModel node_46 (_context, 46, 2, "T216", 48.8628, 1.88996, 0, 0)
        NodeModel node_47 (_context, 47, 3, "T301", 48.8631, 1.88509, 0, 0)
        NodeModel node_48 (_context, 48, 3, "T302", 48.863, 1.88569, 0, 0)
        NodeModel node_49 (_context, 49, 3, "T303", 48.8637, 1.88599, 0, 0)
        NodeModel node_50 (_context, 50, 3, "T304", 48.8645, 1.88698, 0, 0)
        NodeModel node_51 (_context, 51, 3, "T305", 48.8643, 1.88743, 0, 0)
        NodeModel node_52 (_context, 52, 3, "T306", 48.8639, 1.88761, 0, 0)
        NodeModel node_53 (_context, 53, 3, "T307", 48.8636, 1.88802, 0, 0)
        NodeModel node_54 (_context, 54, 3, "T308", 48.8629, 1.88813, 0, 0)
        NodeModel node_55 (_context, 55, 3, "T309", 48.8639, 1.88811, 0, 0)
        NodeModel node_56 (_context, 56, 3, "T310", 48.8648, 1.88741, 0, 0)
        NodeModel node_57 (_context, 57, 3, "T311", 48.8644, 1.88859, 0, 0)
        NodeModel node_58 (_context, 58, 3, "T312", 48.8635, 1.88897, 0, 0)
        NodeModel node_59 (_context, 59, 3, "T313", 48.8638, 1.88922, 0, 0)
        NodeModel node_60 (_context, 60, 3, "T314", 48.864, 1.88964, 0, 0)
        NodeModel node_61 (_context, 61, 4, "T401", 48.8651, 1.88414, 0, 0)
        NodeModel node_62 (_context, 62, 4, "T402", 48.8644, 1.88512, 0, 0)
        NodeModel node_63 (_context, 63, 4, "T403", 48.8653, 1.88463, 0, 0)
        NodeModel node_64 (_context, 64, 4, "T404", 48.8658, 1.88435, 0, 0)
        NodeModel node_65 (_context, 65, 4, "T405", 48.8663, 1.88454, 0, 0)
        NodeModel node_66 (_context, 66, 4, "T406", 48.8657, 1.88487, 0, 0)
        NodeModel node_67 (_context, 67, 4, "T407", 48.865, 1.88521, 0, 0)
        NodeModel node_68 (_context, 68, 4, "T408", 48.8651, 1.88559, 0, 0)
        NodeModel node_69 (_context, 69, 4, "T409", 48.8653, 1.88556, 0, 0)
        NodeModel node_70 (_context, 70, 4, "T410", 48.865, 1.88608, 0, 0)
        NodeModel node_71 (_context, 71, 4, "T411", 48.8655, 1.88677, 0, 0)
        NodeModel node_72 (_context, 72, 4, "T412", 48.8655, 1.88622, 0, 0)
        NodeModel node_73 (_context, 73, 4, "T413", 48.8661, 1.88517, 0, 0)
        NodeModel node_74 (_context, 74, 4, "T414", 48.8665, 1.88496, 0, 0)
        NodeModel node_75 (_context, 75, 4, "T415", 48.8668, 1.88585, 0, 0)
        NodeModel node_76 (_context, 76, 2, "", 48.8624, 1.88598, 0, 0)
        NodeModel node_77 (_context, 77, 2, "", 48.8621, 1.88525, 0, 0)
        NodeModel node_78 (_context, 78, 2, "", 48.861, 1.88718, 0, 0)
        NodeModel node_79 (_context, 79, 2, "", 48.8614, 1.88727, 0, 0)
        NodeModel node_80 (_context, 80, 2, "", 48.8616, 1.88737, 0, 0)
        NodeModel node_81 (_context, 81, 2, "", 48.8613, 1.88707, 0, 0)
        NodeModel node_82 (_context, 82, 2, "", 48.8625, 1.88765, 0, 0)
        NodeModel node_83 (_context, 83, 2, "", 48.8624, 1.88804, 0, 0)
        NodeModel node_84 (_context, 84, 2, "", 48.8624, 1.88718, 0, 0)
        NodeModel node_85 (_context, 85, 2, "", 48.8621, 1.88731, 0, 0)
        NodeModel node_86 (_context, 86, 3, "", 48.8627, 1.88742, 0, 0)
        NodeModel node_87 (_context, 87, 3, "", 48.8627, 1.88789, 0, 0)
        NodeModel node_88 (_context, 88, 3, "", 48.8632, 1.88823, 0, 0)
        NodeModel node_89 (_context, 89, 3, "", 48.8634, 1.88913, 0, 0)
        NodeModel node_90 (_context, 90, 3, "", 48.8636, 1.88958, 0, 0)
        NodeModel node_91 (_context, 91, 3, "", 48.8636, 1.89008, 0, 0)
        NodeModel node_92 (_context, 92, 3, "", 48.8638, 1.88941, 0, 0)
        NodeModel node_93 (_context, 93, 3, "", 48.8641, 1.88911, 0, 0)
        NodeModel node_94 (_context, 94, 3, "", 48.8639, 1.88853, 0, 0)
        NodeModel node_95 (_context, 95, 3, "", 48.8641, 1.88778, 0, 0)
        NodeModel node_96 (_context, 96, 3, "", 48.8643, 1.88677, 0, 0)
        NodeModel node_97 (_context, 97, 3, "", 48.865, 1.88763, 0, 0)
        NodeModel node_98 (_context, 98, 3, "", 48.8642, 1.88519, 0, 0)
        NodeModel node_99 (_context, 99, 3, "", 48.8643, 1.88555, 0, 0)
        NodeModel node_100 (_context, 100, 3, "", 48.8641, 1.8848, 0, 0)
        NodeModel node_101 (_context, 101, 3, "", 48.865, 1.88793, 0, 0)
        NodeModel node_102 (_context, 102, 3, "", 48.8643, 1.88843, 0, 0)
        NodeModel node_103 (_context, 103, 4, "", 48.8659, 1.88456, 0, 0)
        NodeModel node_104 (_context, 104, 4, "", 48.8653, 1.88409, 0, 0)
        NodeModel node_105 (_context, 105, 4, "", 48.8662, 1.88452, 0, 0)
        NodeModel node_106 (_context, 106, 4, "", 48.8661, 1.88491, 0, 0)
    }
