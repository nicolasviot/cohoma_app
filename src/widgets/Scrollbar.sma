...
import impl.scrollbar.paging
import impl.scrollbar.clamp
import impl.scrollbar.inverse_transform

// TODO: fix cairo bug with enter/leave when moving shape
// TODO: make it actually usable

_define_
Scrollbar(Process frame) inherits IWidget () {
  ...
  Switch picking_view (initial) {
    ...
    Component dragging {
      ...
      inverse_transform _ (transform, frame.height, frame.height, win_height_in_model) // FIXME? not working as planned
