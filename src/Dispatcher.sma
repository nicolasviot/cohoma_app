...
/*AssignmentSequence store_data (0) {
    _latitude =: _list.[$_robot_id].lat
	_longitude =: _list.[$_robot_id].lon
   }
*/
/*_robot_id -> store_data*/
...
LogPrinter lp ("lat/long: ")
LogPrinter lp2 ("robot_id : ")
_latitude + " - " + _longitude => lp.input
_robot_id => lp2.input
}